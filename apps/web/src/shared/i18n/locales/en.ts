...
export const en = {
  ...
  wake: {
    ...
    endMode: 'End of command',
    endModePhrase: 'End phrase (e.g. “go ahead”)',
    endModeSilence: 'Pause (waits for silence)',
    endPhrases: 'End phrases (one per line)',
    endPhrasesHint: 'Say one of these to finish the command. Recognized via Vosk (same model as wake-word).',
